...
export class RaceManager {
  ...
  start(){this.elapsed=0;this.karts.forEach(k=>{k.progress=k.projection.t>.9?k.projection.t-1:0;k.rank=k.id+1;});this.countdown=3.6;this.state=this.mode==='practice'?'racing':'countdown';}
